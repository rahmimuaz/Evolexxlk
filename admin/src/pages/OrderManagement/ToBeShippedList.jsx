...
const ToBeShippedList = () => {
  ...
  // Make sure you have REACT_APP_API_BASE_URL set in your .env.development or .env.production file
  const API_BASE_URL = process.env.REACT_APP_API_BASE_URL || 'http://localhost:5001'; // Fallback for dev
  ...
  const downloadPdf = (order) => {
    const doc = new jsPDF();
    doc.setFontSize(16);
    // ACCESS DIRECTLY: order.orderNumber
    ...
    yPos += 7;
    // ACCESS DIRECTLY: order.totalPrice
    doc.text(`  Total Price: $${order.totalPrice?.toFixed(2) || 'N/A'}`, 10, yPos);
    yPos += 7;
    // ACCESS DIRECTLY: order.paymentMethod
                    ...
                    <div className="action-buttons">
                      ...
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 2 0 01.707.293l5.414 5.414a1 2 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        Download PDF
                      </button>
                    </div>
